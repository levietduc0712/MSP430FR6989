//******************************************************************************
//  MSP430FR6989 - PushButton P1.1, PushButton P1.2, GREEN LED P9.7 and RED LED P1.0
...
//  Description: The GREEN LED is high, and the RED LED is low; if the pushbutton P1.1 is pushed, the GREEN LED is low, and the RED LED is high.
//  If the pushbutton P1.2 is pushed, GREEN and RED LED are toggle.
//
//               MSP430FR6989
//            -----------------
//        /|\|                 |
...
int main(void)
{
    ...
    P1OUT |= BIT2;                          // Set output of Pin 2 - Port 1 is high
    P1REN |= BIT2;                          // Pull-up enable
    ...
    while(1)
    {
        ...
        while((BIT2 & P1IN) == 0)           // Check if P1.2 is pushed ? 00000100(BIT2) & 00000000 == 0 ?
        {
